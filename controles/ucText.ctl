...
'27/05/2022 Revision 1.0.2
            'Unicode character input problem fixed, added function
            'ComCtlsPeekCharCode() extracted from Krool TextBoxW.ctl
'01/06/2022 Revision 1.0.3
            'ListPlus
'--------------------------SubClass by wqweto
...
Private Function ComCtlsPeekCharCode(ByVal hwnd As Long) As Long
    Dim Msg As TMSG
    ...
    Select Case uMsg
        ...
        Case WM_CHAR
            ...
            If TextBoxCharCodeCache <> 0 Then
                KeyAscii = CUIntToInt(TextBoxCharCodeCache And &HFFFF&)
                TextBoxCharCodeCache = 0
            Else
                KeyAscii = CUIntToInt(wParam And &HFFFF&)
            End If
